    ...
    <div className="min-h-screen bg-linear-to-br from-brand/5 via-white to-brand/5 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/reset-password" className="text-sm text-brand hover:text-brand-hover font-medium">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="mt-6 text-center text-gray-600">
          ...
          <Link href="/auth/signup" className="text-brand hover:text-brand-hover font-semibold">
            Sign up
          </Link>
        </p>
      </motion.div>
